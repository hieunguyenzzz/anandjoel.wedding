...
import { default as bite, default as events } from '../asset/bite-slide-1.png';
    ...
    <div className=" w-full  text-[12px] lg:text-lg text-[#111111ff] flex flex-col gap-6 relative  isolate ">
      ...
      <div id={containerId} className='overflow-hidden container mx-auto flex flex-col relative justify-center items-center lg:relative '>
        <div id={innerId} className='transition-transform duration-300 ease-in-out'>
          ...
          <video autoPlay muted loop className="absolute inset-0 w-full h-full  z-0 hidden transition-transform lg:block   max-w-full object-cover animate-fade"
            src="https://res.cloudinary.com/dfgbpib38/video/upload/f_auto:video,q_auto/q3xmwfuu7jt1evh0gkwh" />
